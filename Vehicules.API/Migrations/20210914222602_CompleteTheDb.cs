        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicules_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vehicules_Brands_BrandId",
                        column: x => x.BrandId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Histories_Vehicules_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehiculePhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VehiculePhotos_Vehicules_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehiculePhotos_VehicleId",
                table: "VehiculePhotos",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_Vehicules_BrandId",
                table: "Vehicules",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_Vehicules_Plaque",
                table: "Vehicules",
                column: "Plaque",
                unique: true);
