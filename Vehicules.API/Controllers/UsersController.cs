...
namespace Vehicules.API.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> EditVehicle(int? id)
        {
            ...
            Vehicle vehicle = await _context.Vehicules
                .Include(x => x.User)
                .Include(x => x.Brand)
        ...
        public async Task<IActionResult> EditVehicle(int id, VehicleViewModel vehicleViewModel)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    _context.Vehicules.Update(vehicle);
                    await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteImageVehicle(int? id)
        {
            ...
            VehiclePhoto vehiclePhoto = await _context.VehiculePhotos
                .Include(x => x.Vehicle)
                .FirstOrDefaultAsync(x => x.Id == id);
            ...
            _context.VehiculePhotos.Remove(vehiclePhoto);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> AddHistory(int? id)
        {
            ...
            Vehicle vehicle = await _context.Vehicules.FindAsync(id);
            if (vehicle == null)
            {
                return NotFound();
            }
